...
//                HashMapParams.put(ImageTag, GetNamaGambar);
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("http://192.168.43.126/tokoali/tambahdata2.php", HashMapParams);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(TambahData.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
